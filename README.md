The major challenge is to choose the best features and machine learning model for better sales prediction so that store can manage the stock in advance for unforeseen demand.
